...
if __name__ == '__main__':
    ...
    values = Moves_12dof.move_foot(qinit, 0.075, 0.065, on_x=True, dt=0.01, sub=6) # safe sub=15
    value = Moves_12dof.move_foot(qinit, 0.075, 0.055, on_x=True, dt=0.01, sub=6, front=False)
    while 1 :
