...
if __name__ == '__main__':
    ...
    values = Moves_12dof.move_foot(qinit, 0.075, 0.065, on_x=True, sub=100) # safe sub=6
    value = Moves_12dof.move_foot(qinit, 0.075, 0.055, on_x=True, sub=100, front=False)
    # while 1 :
