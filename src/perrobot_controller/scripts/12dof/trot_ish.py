...
if __name__ == '__main__':
    ...
    FL = Moves_12dof.move_foot(qinit, period=0.065, amplitude=0.025, on_x=True, num_points=10, sub=6, front=True)
    FR = Moves_12dof.move_foot(qinit, period=0.065, amplitude=0.025, on_x=True, num_points=10, sub=6, front=True)
    HL = Moves_12dof.move_foot(-qinit, period=0.065, amplitude=0.025, on_x=True, num_points=10, sub=6, front=False)
    HR = Moves_12dof.move_foot(-qinit, period=0.065, amplitude=0.025, on_x=True, num_points=10, sub=6, front=False)
